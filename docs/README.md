...
- [Auditoría y plan — Canal de feedback para la beta profesional](AUDITORIA_Y_PLAN_FEEDBACK_BETA_PROFESIONALES_2026-08-11.md):
  arquitectura, seguridad y trazabilidad de la implementación FB.0–FB.5 del
  canal privado para profesionales; estado de desarrollo: completo y validado
  en `codex/beta-feedback`, pendiente únicamente de despliegue autorizado.
